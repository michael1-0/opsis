        ...
        <div className="max-w-[1100px] mx-auto px-8 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl border-2 border-slate-200 shadow-2xl max-w-[260px]">
              ...
              <p className="text-sm text-slate-700 font-['Lexend']">
                Menggunakan teknologi <i>Deep Learning</i> terkini untuk
                memberikan analisis awal yang membantu Anda memahami kondisi
                kesehatan saraf optik lebih cepat.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="max-w-[1100px] mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <p className="font-['Lexend'] text-xl text-slate-700 max-w-2xl mx-auto">
              Glaukoma adalah kondisi rusaknya saraf mata akibat tekanan bola
              mata yang terlalu tinggi, yang jika dibiarkan dapat menyebabkan
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto">
            <div className="md:col-span-7 bg-white p-10 rounded-2xl border-2 border-[#c2c6d1] flex flex-col justify-between shadow-sm">
              <div>
                ...
                <p className="font-['Lexend'] text-lg text-slate-700">
                  Glaukoma melibatkan kerusakan pada saraf optik, seringkali
                  disebabkan oleh tekanan intraokular yang tinggi. Deteksi dini
                  sangat penting karena kerusakan pada saraf tidak dapat
                  dipulihkan.
                </p>
              </div>
            ...
            <div className="md:col-span-5 bg-[#003461] text-white p-10 rounded-2xl flex flex-col justify-center relative overflow-hidden shadow-lg">
              <div className="relative z-10">
                ...
                <p className="font-['Lexend'] text-lg text-blue-50 mb-6 leading-relaxed">
                  ...
                  penglihatan sudah lanjut. Protokol screening proaktif Opsis
                  mengidentifikasi faktor risiko bertahun-tahun sebelum gejala
                  muncul.
                </p>
                <Link
                  to="/gejala"
                  className="font-['Public_Sans'] text-lg flex items-center gap-2 hover:gap-4 transition-all font-bold underline decoration-2 underline-offset-4"
                >
                  Pelajari Gejala{" "}
            ...
            <div className="md:col-span-8 bg-white border-2 border-[#c2c6d1] p-8 rounded-2xl flex flex-col md:flex-row items-center gap-8 shadow-sm">
              <div className="flex-grow">
                ...
                <p className="font-['Lexend'] text-lg text-slate-700">
                  Meskipun kehilangan penglihatan akibat glaukoma bersifat
                  permanen, rencana perawatan yang dipandu Opsis dan pemeriksaan
      ...
      <section aria-labelledby="timing-heading" className="py-24 bg-white">
        <div className="max-w-[1100px] mx-auto px-8 flex flex-col md:flex-row items-center gap-20">
            ...
            <div className="relative">
              ...
              <div className="relative grid grid-cols-2 gap-4">
                <img
                  ...
                  className="rounded-xl border-2 border-slate-200 shadow-md"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuCXZJWQBrVpCi4gV3qtfCnFEcCW3oL0yDao7c7hPp1BOawF7w2Ac6sAWgG21QYnYv3F0j6a7rkEJVEkkg-sTaJxwZsHZgGDB5fT64FFkSuZq2hm63Y4UaWJMuJt0jQ5C0xs8Kfss7KJ3GAGQtOgqNGU_ywTYoKFJt5miO9hUncQ5Uc6wEncGgms3Isfsgb8t9vEe4k3NCU8dglyQ8XbTaIjG6AksyYpM5OCF-uTO1ya5lcwe3IXk6zRxUoZj1f-LCcmMWOwsuRRHuDY"
                />
                <img
                  alt="Pemindaian pencitraan digital Opsis"
                  className="rounded-xl border-2 border-slate-200 mt-8 shadow-md"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuBKV2oKIJloxRbFX4I-bIqnuDBOmiKMRq43VvaUSOTh834zsgVpVYVIRyfNFbI54IE1LDKL4oJUiAEWxwzksRUT3dgy-JU64rTCKxX8f7jnbxwDJjsgdtmEN4Wo5TLpAO82isAS-nbiXxrejoTOSh84PPToB_jeMoYoGBt-MSm0w7oBrWPY63xjoYTOhmKKWln3YDT9yHVPHXCG8FzSvWwpyPmMLERUvwuQeTzyRuAwLXHWwa5hGwjGgjpqCyjH5IgaI7ywcQv3Huzu"
                />
              </div>
            </div>
          </div>
          <div className="md:w-1/2 order-1 md:order-2">
            ...
            <p className="font-['Lexend'] text-xl text-slate-700 mb-8 leading-relaxed">
              Deteksi dini bukan hanya tentang satu tes; ini tentang pemantauan
              berkelanjutan dengan fidelitas tinggi. Opsis mengintegrasikan
              screening klinis dengan pelacakan berbasis rumah untuk memastikan
              tidak ada perubahan tekanan yang terlewatkan.
            </p>
            <ul className="space-y-8" role="list">
              <li className="flex gap-5">
                ...
                <div>
                  ...
                  <p className="text-slate-700 mt-1">
                    Unggah hasil foto fundus Anda dan biarkan AI kami memberikan
                    analisis awal mengenai indikasi kerusakan saraf secara
                    instan.
                  </p>
                </div>
              </li>
              <li className="flex gap-5">
                ...
                <div>
                  ...
                  <p className="text-slate-700 mt-1">
                    Kuesioner adaptif yang memetakan profil risiko Anda
                    berdasarkan gaya hidup, riwayat medis, dan faktor genetik.
                  </p>
                </div>
              </li>
            </ul>
      ...
      <section className="py-24 bg-[#003461] text-white">
        <div className="max-w-[1100px] mx-auto px-8 text-center">
          ...
          <p className="font-['Lexend'] text-xl mb-10 max-w-2xl mx-auto opacity-90">
            Bergabunglah dengan ribuan pengguna lainnya yang telah mempercayakan
            kesehatan mata mereka kepada Opsis. Mulailah perjalanan deteksi dini
            Anda hari ini.
          </p>
          ...
          <div className="space-y-4">
            <details className="group border border-[#c2c6d1] bg-white rounded-xl overflow-hidden shadow-sm">
              ...
              <p className="text-slate-700 font-['Lexend'] p-6 pt-0 leading-relaxed">
                Glaukoma adalah kelompok kondisi mata yang merusak saraf
                optik...
              </p>
            </details>
            <details className="group border border-[#c2c6d1] bg-white rounded-xl overflow-hidden shadow-sm">
              ...
              <p className="text-slate-700 font-['Lexend'] p-6 pt-0 leading-relaxed">
                Opsis menyediakan alat deteksi dini dan pendampingan
                pengelolaan...
              </p>
            </details>
            <details className="group border border-[#c2c6d1] bg-white rounded-xl overflow-hidden shadow-sm">
              ...
              <p className="text-slate-700 font-['Lexend'] p-6 pt-0 leading-relaxed">
                Tidak, Opsis adalah alat pendukung. Selalu konsultasikan hasil
