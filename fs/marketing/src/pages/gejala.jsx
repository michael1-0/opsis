        ...
        <div className="max-w-[1100px] mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#ffffff] border-2 border-[#c2c6d1] rounded-xl p-8 flex flex-col items-start transition-colors duration-300 hover:border-[#003461]">
              ...
              <h3 className="font-['Public_Sans'] font-bold text-2xl text-[#1c1b1b] mb-4">
                Penyempitan Lapang Pandang
              </h3>
              <p className="font-['Lexend'] text-[#424750]">
                Hilangnya penglihatan tepi atau samping, sering terasa seperti
                melihat melalui sebuah terowongan. Ini adalah tanda khas
                glaukoma sudut terbuka tingkat lanjut.
              </p>
            </div>
            ...
            <div className="bg-[#ffffff] border-2 border-[#c2c6d1] rounded-xl p-8 flex flex-col items-start transition-colors duration-300 hover:border-[#003461]">
              ...
              <p className="font-['Lexend'] text-[#424750]">
                Melihat lingkaran menyerupai pelangi di sekitar lampu terang,
                terutama di malam hari. Gejala ini bisa disertai dengan
            ...
            <div className="bg-[#ffffff] border-2 border-[#c2c6d1] rounded-xl p-8 flex flex-col items-start transition-colors duration-300 hover:border-[#003461]">
              ...
              <p className="font-['Lexend'] text-[#424750]">
                Rasa sakit yang tiba-tiba dan parah pada mata, seringkali
                disertai sakit kepala, mual, dan kemerahan. Ini mengindikasikan
                keadaan darurat medis (glaukoma sudut tertutup akut).
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="flex flex-col gap-6">
            ...
            <p className="font-['Lexend'] text-lg text-[#424750]">
              Kerusakan saraf optik akibat glaukoma terjadi secara perlahan.
              Karena otak kita pandai mengisi informasi visual yang hilang, Anda
              mungkin tidak menyadari penurunan penglihatan sampai kondisinya
              sudah sangat lanjut.
            </p>
            <p className="font-['Lexend'] text-lg text-[#424750]">
              Bandingkan kejernihan penglihatan normal dengan efeks penyempitan
              lapang pandang pada penderita glaukoma melalui simulasi di
              samping.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="flex flex-col gap-4">
              ...
              <div className="text-center font-['Public_Sans'] font-bold text-[#1c1b1b]">
                Penglihatan Normal
              </div>
            </div>
            <div className="flex flex-col gap-4">
        ...
        <div className="max-w-[1100px] mx-auto px-8">
          <div className="bg-[#fcf9f8] rounded-xl p-12 border-2 border-[#c2c6d1] shadow-sm flex flex-col md:flex-row gap-12 items-start">
            <div className="md:w-1/3">
              ...
              <p className="font-['Lexend'] text-lg text-[#424750]">
                Kerusakan penglihatan akibat glaukoma bersifat permanen. Namun,
                dengan pengobatan yang tepat waktu, kehilangan penglihatan lebih
            ...
            <div className="md:w-2/3 flex flex-col gap-8 w-full">
              <div className="flex items-start gap-6 bg-[#ffffff] p-6 rounded-lg border-2 border-[#c2c6d1]">
                ...
                <div>
                  <h4 className="font-['Public_Sans'] font-bold text-xl text-[#1c1b1b] mb-2">
                    Pencegahan Kebutaan
                  </h4>
                  <p className="font-['Lexend'] text-sm text-[#424750]">
                    Diagnosis dini adalah faktor terpenting dalam mencegah
                    kebutaan total akibat glaukoma.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-6 bg-[#ffffff] p-6 rounded-lg border-2 border-[#c2c6d1]">
                ...
                <div>
                  ...
                  <p className="font-['Lexend'] text-sm text-[#424750]">
                    Terapi medis dapat menurunkan tekanan intraokular dan
                    menghentikan kerusakan saraf lebih lanjut.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-6 bg-[#ffffff] p-6 rounded-lg border-2 border-[#c2c6d1]">
                ...
                <div>
                  ...
                  <p className="font-['Lexend'] text-sm text-[#424750]">
                    Dengan lapang pandang yang terjaga, Anda dapat terus
                    melakukan aktivitas sehari-hari dengan aman dan mandiri.
                  </p>
                </div>
              </div>
            </div>
