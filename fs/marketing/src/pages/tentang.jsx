      ...
      <section className="flex flex-col md:flex-row gap-12 items-center">
        <div className="w-full md:w-3/5 space-y-6">
          ...
          <p className="font-['Lexend'] text-xl text-[#424750] leading-relaxed">
            Glaukoma merupakan salah satu penyebab kebutaan permanen terbesar di
            dunia. Penyakit ini seringkali tidak menunjukkan gejala pada tahap
            awal, menyoroti urgensi hadirnya solusi deteksi dini yang mudah
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-3 bg-[#ffffff] border-2 border-[#dcd9d9] rounded-xl p-8 hover:border-primary transition-colors focus-within:ring-4 focus-within:ring-primary">
            <p className="font-['Lexend'] text-xl text-[#1c1b1b]">
              ...
              teknologi mutakhir dengan pendekatan yang berpusat pada manusia
              untuk memberdayakan pasien dalam memantau kesehatan mata mereka.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-[#f6f3f2] border-2 border-[#dcd9d9] rounded-xl overflow-hidden focus-within:ring-4 focus-within:ring-primary">
            ...
            <div className="p-8 space-y-4">
              <h3 className="font-['Public_Sans'] text-2xl text-[#1c1b1b] font-bold">
                Portal Edukasi Publik
              </h3>
              <p className="font-['Lexend'] text-[#424750]">
                Bagian terbuka dari platform kami yang didedikasikan untuk
                meningkatkan kesadaran masyarakat. Temukan artikel komprehensif
                mengenai gejala, metode pengobatan terkini, dan panduan
                pencegahan glaukoma tanpa perlu mendaftar.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#f6f3f2] border-2 border-[#dcd9d9] rounded-xl overflow-hidden focus-within:ring-4 focus-within:ring-primary">
            ...
            <div className="p-8 space-y-4">
              <h3 className="font-['Public_Sans'] text-2xl text-[#1c1b1b] font-bold">
                Aplikasi Pasien Khusus
              </h3>
              <p className="font-['Lexend'] text-[#424750]">
                Ruang personal yang aman setelah proses masuk (login). Akses
                alat deteksi dini berbasis AI, rekam medis mandiri, jadwal
                pengingat tetes mata, dan terhubung dengan komunitas sesama
                pasien untuk saling mendukung.
              </p>
            </div>
          </div>
        </div>
